...
import FlightsFormView from 'pages/CRUD/Flights/form/FlightsFormView';
import { push } from 'connected-react-router';
import actions from 'actions/flights/flightsFormActions';
import { connect } from 'react-redux';

const FlightsFormPageView = (props) => {
...
export default connect(mapStateToProps)(FlightsFormPageView);
