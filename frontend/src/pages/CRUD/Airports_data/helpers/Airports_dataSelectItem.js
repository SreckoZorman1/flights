...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/airports_data/autocomplete`, { params });
  return response.data;
}

const Airports_dataSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.airports_data.hasPermissionToCreate,
});

export default connect(select)(Airports_dataSelectItem);
