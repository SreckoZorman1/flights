...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/seats/autocomplete`, { params });
  return response.data;
}

const SeatsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.seats.hasPermissionToCreate,
});

export default connect(select)(SeatsSelectItem);
